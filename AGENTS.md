...
The YouTube path first asks yt-dlp for metadata, then downloads and converts audio to MP3 before transcription. Failures during metadata lookup are YouTube/yt-dlp failures, not Whisper failures.
